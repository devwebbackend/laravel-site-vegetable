    				...
    				<div class="cart-list">
	    				<table class="table">
						   ...
						   @if(Session::has('cart'))
								...
								<tr class="text-center">
									<form method="POST" action="{{url('remouve_account/'.$product['product_id'])}}">
									@csrf
						        <td class="product-remove"><button type="submit"><span class="ion-ios-close"></span></td>
									</form>
								...
								<form method="POST" action="{{url('updateqty/'.$product['product_id'])}}">
									@csrf
									<td class="quantity">
